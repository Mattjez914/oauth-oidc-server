...
module.exports = (app, provider) => {
  ...
  // app.post('/addClient', setNoCache, async (req, res, next) => {
  //   let sampleClient = {    
  //     client_id: 'test_implicit_app',
  //     client_secret: 'secret',
  //     grant_types: ['implicit', 'authorization_code'],
  //     response_types: ['code id_token'],
  //     redirect_uris: ['https://test.com:3000/redirect'],
  //     token_endpoint_auth_method: 'none',
  //     revocation_endpoint_auth_method: 'none'
  //   }

  //   await provider.Client;
  //   let client = await provider.clientAdd(sampleClient);
  //   console.log(client);
  //   res.send(client);
  // });

  // app.delete('/removeClient', setNoCache, async (req, res, next) => {
  //   let client = await provider.Client.find('test_implicit_app')
  //   console.log(client)
